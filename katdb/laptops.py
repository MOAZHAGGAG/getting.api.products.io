...
def extract_product_data(product):
    """
    Extract relevant data from a product dictionary, including the category and current datetime.
    """
    ...
    return {
        ...
        "brand": brand,
        "link": product_link,
        "category": "laptop",  # Add category to the dictionary
...
def save_to_postgresql(products):
    ...
    try:
        ...
        # Prepare the insert statement (updated to include datetime)
        insert_query = """
        INSERT INTO productstes (name, specs, new_price, old_price, link, brand, category, datetime)
        VALUES (%s, %s, %s, %s, %s, %s, %s, %s)
        """
        
        # Prepare the data for batch insert (updated to include datetime)
        product_data = [(product['name'], product['specs'], product['new_price'], product['old_price'], product['link'], product['brand'], product['category'], product['datetime']) for product in products]
